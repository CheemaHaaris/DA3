---
title: "Prediction and Classification of Models"
...
```{r,echo=FALSE,message=FALSE,warning=FALSE, fig.height=3, fig.width=8, fig.cap="ROC Curves"}
...
a %>% 
  kbl(caption = "Confusion Matrix Model X4") %>% 
  kable_classic(full_width = F, html_font = "Cambria") %>% 
...
```{r, echo=FALSE,message=FALSE,warning=FALSE}
b <- round( cm_rf / sum(cm_rf) * 100 , 1 ) 

b %>% 
  kbl(caption = "Confusion Matrix Random Forest") %>% 
  kable_classic(full_width = F, html_font = "Cambria") %>% 
  kable_styling(latex_options = "HOLD_position")
...
The confusion matrices for both can be seen below. 
